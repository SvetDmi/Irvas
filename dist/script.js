...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_moduls_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img > img", "do_image_more", "inline");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/js/moduls/utils.js");



var modalChangeState = function modalChangeState(state) {
  var balconForm = document.querySelectorAll(".balcon_icons_img"),
  ...
  Object(_utils__WEBPACK_IMPORTED_MODULE_1__["checkNumber"])(balconHeight);
  Object(_utils__WEBPACK_IMPORTED_MODULE_1__["checkNumber"])(balconWidth);
...
/* harmony default export */ __webpack_exports__["default"] = (modalChangeState);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./src/js/moduls/utils.js");
...
var forms = function forms(state) {
  ...
  Object(_utils__WEBPACK_IMPORTED_MODULE_5__["checkNumber"])(phoneInputs);
  ...
  allForms.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      postData("assets/server.php", formData).then(function (res) {
        ...
        setTimeout(function () {
          Object(_utils__WEBPACK_IMPORTED_MODULE_5__["closeAllPopups"])();
        }, 5000);
      }).catch(function () {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (element) {
      element.addEventListener("click", function (e) {
        ...
        Object(_utils__WEBPACK_IMPORTED_MODULE_1__["closeAllPopups"])();
        modal.style.display = "block";
        document.body.style.overflow = "hidden";
        document.body.style.marginRight = "".concat(scroll, "px"); //или использовать класс из bootstap - document.body.classList.add("modal-open");
      });
    });
  ...
  function calcScroll() {
    ...
    var scrollWight = div.offsetWidth - div.clientWidth;
    div.remove();
    return scrollWight;
  }
  ...
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false); // showModalInTime(".popup", 60000);
};
...
var tabs = function tabs(tabsSectionSelector, tabsSelector, tabsContentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : "block";
  var tabsSection = document.querySelector(tabsSectionSelector),
  ...
  function hideTab() {
    ...
    tabs.forEach(function (item) {
      item.classList.remove(activeClass); // item.children[index].classList.remove(activeClass);
    });
  }

  function showTab() {
    var i = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    tabsContent[i].style.display = display; // tabs[i].children[index].classList.add(activeClass);
  ...
  tabsSection.addEventListener("click", function (e) {
    ...
    if (target && target.classList.contains(tabsSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabsSelector.replace(/\./, "")) || target.parentNode.parentNode.classList.contains(tabsSelector.replace(/\./, ""))) {
      tabs.forEach(function (item, i) {
        if (target == item || target.parentNode == item || target.parentNode.parentNode == item) {
          hideTab();
          showTab(i);
        }
      });
...
var timer = function timer(selector, deadline) {
  ...
  var setTimer = function setTimer(id, endtime) {
...
/***/ "./src/js/moduls/utils.js":
/*!********************************!*\
  !*** ./src/js/moduls/utils.js ***!
  \********************************/
/*! exports provided: checkNumber, closeAllPopups */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkNumber", function() { return checkNumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeAllPopups", function() { return closeAllPopups; });
/* harmony import */ var core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.string.replace */ "./node_modules/core-js/modules/es.string.replace.js");
/* harmony import */ var core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_replace__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
...
var checkNumber = function checkNumber(elem) {
  elem.forEach(function (item) {
